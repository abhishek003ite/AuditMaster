									...
									<div class="m-portlet__body">
										<div class="m-widget27 m-portlet-fit--sides">
											<div class="m-widget27__pic">
												<img src="<?= base_url() ?>/assets/app/media/img//bg/bg-4.jpg" alt="">
												...
												<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
													...
													<div class="m-timeline-2__item m--margin-top-30">
														...
														<div class="m-list-pics m-list-pics--sm m--padding-left-20">
															<a href="#">
																<img src="<?= base_url() ?>/assets/app/media/img/users/100_4.jpg" title="">
															</a>
															<a href="#">
																<img src="<?= base_url() ?>/assets/app/media/img/users/100_13.jpg" title="">
															</a>
															<a href="#">
																<img src="<?= base_url() ?>/assets/app/media/img/users/100_11.jpg" title="">
															</a>
															<a href="#">
																<img src="<?= base_url() ?>/assets/app/media/img/users/100_14.jpg" title="">
															</a>
														</div>
													</div>
													<div class="m-timeline-2__item m--margin-top-30">
