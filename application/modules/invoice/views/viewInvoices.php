									...
									<tbody>
									    <?php $i = 1; foreach($users as $user){ ?>
									        <tr>
									            ...
									            <td><a href="<?= site_url() ?>invoice/editInvoice/<?= $user['id'] ?>"><i class="fa fa-pencil"></i></a> | <a  onclick="deleteConff('<?= site_url('invoice/deleteInvoice/'.$user['id']."/same") ?>')"><i class="fa fa-trash" style="color: red;"></i></a></td>
									        </tr>
									    <?php $i++; } ?>
									</tbody>
								</table>
