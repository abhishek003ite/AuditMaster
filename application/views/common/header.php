<?php $user = $this->session->userdata('user_data_session'); ?>
<!DOCTYPE html>
<html lang="en" >
	<!-- begin::Head -->
	<head>
														...
														<div class="m-dropdown__content">
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="<?= site_url() ?>/dashboard/profile" class="m-nav__link">
																...
																<li class="m-nav__item">
																	<a href="<?php echo base_url(); ?>welcome/logout" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">
																		Logout
																	</a>
																</li>
															</ul>
